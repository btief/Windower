...
function init_gear_sets()
    ...
    sets.midcast.Ballad = {legs="Aoidos' Rhing. +2", range="Gjallarhorn"}
    sets.midcast.Lullaby = {hands="Brioso Cuffs", range="Gjallarhorn"}
    sets.midcast.Madrigal = {head="Fili calot", back="Intarabus's cape", range="Gjallarhorn"}
    sets.midcast.March = {hands="Fili manchettes", range="Gjallarhorn"}
    sets.midcast.Minuet = {body="Fili hongreline", range="Gjallarhorn"}
	sets.midcast.Etude = {head="Mousai Turban", range="Gjallarhorn"}
    ...
    sets.midcast.Carol = {head="Aoidos' Calot +2",
        ...
        legs="Aoidos' Rhing. +2",feet="Aoidos' Cothrn. +2", range="Gjallarhorn"}
    sets.midcast["Sentinel's Scherzo"] = {feet="Aoidos' Cothrn. +2", range="Gjallarhorn"}
    ...
    sets.midcast.DaurdablaDummy = {main="Izhiikoh",
    ...
    sets.idle = {
		...
		back={ name="Intarabus's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Phys. dmg. taken-4%',}},
	}
