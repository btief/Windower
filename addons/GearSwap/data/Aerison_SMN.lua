...
function job_setup()
    ...
    magicalRagePacts = S{
        ...
        'Holy Mist','Lunar Bay','Night Terror','Level ? Holy', 'Impact', 'Conflag Strike'}
	...
	pacts.main = {['Ifrit']='Flaming Crush', ['Ramuh']='Volt Strike', ['Garuda']='Predator Claws', ['Shiva']='Rush', ['Leviathan']='Spinning Dive', ['Carbuncle']='Holy Mist', ['Fenrir']='Eclipse Bite'}
...
function init_gear_sets()
	...
	sets.precast.WS['Garland of Bliss'] = {
		...
		body="Amalric Doublet",			-- Refresh +2
		hands={ name="Merlinic Dastanas", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Blood Pact Dmg.+9','Pet: MND+9','Pet: Mag. Acc.+4',}},
		legs="Assid. Pants +1",			-- Refresh +1~2 & Perp -3
		feet="Amalric Nails",			-- Perp -8
		neck="Fotia Gorget",
		waist="Fotia Belt",
		ear1="Brutal Earring",
		ear2="Friomisi Earring",		-- Perp -2
		ring1="Rajas Ring",				-- Perp -1
		ring2="Chirich Ring",
    ...
    body="Con. Doublet +3",
    hands={ name="Apogee Mitts +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},
    ...
    head={ name="Apogee Crown +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Blood Pact Dmg.+5','Pet: Mag. Acc.+14','Pet: "Mag.Atk.Bns."+3',}},
    legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},
    ...
    -- Resting sets
    sets.resting = {main=gear.Staff.HMP,ammo="Sancus Sachet",
        ...
        back="Pahtli Cape",waist="Austerity Belt",legs="Nares Trews",feet="Baayami Sabots"}
...
function job_get_spell_map(spell)
    if spell.type == 'BloodPactRage' then
        ...
        elseif spell.english == "Flaming Crush" or spell.english == "Burning Strike" then
