...
function init_gear_sets()
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
		...
		right_ring="Dingir Ring",
		back={ name="Gunslinger's Cape", augments={'Enmity-2','"Mag.Atk.Bns."+2','"Phantom Roll" ability delay -4','Weapon skill damage +3%',}},
        })
    ...
    sets.engaged = {
		...
		hands="Meg. Gloves +2",
		legs="Meg. Chausses +2",
		feet={ name="Taeon Boots", augments={'Accuracy+15 Attack+15','"Triple Atk."+2','Weapon skill damage +2%',}},
