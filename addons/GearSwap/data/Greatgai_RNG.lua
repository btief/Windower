...
function init_gear_sets()
    ...
    sets.precast.RA = {
		...
		hands={ name="Taeon Gloves", augments={'Rng.Acc.+19 Rng.Atk.+19','"Snapshot"+4','"Snapshot"+5',}},
		legs="Nahtirah Trousers",
		feet={ name="Taeon Boots", augments={'Rng.Acc.+18 Rng.Atk.+18','"Snapshot"+5','"Snapshot"+5',}},
		neck="Iskur Gorget",
		waist="Impulse Belt",
		...
		back={ name="Lutian Cape", augments={'STR+1','AGI+1','"Store TP"+2','"Snapshot"+3',}},
      } --61/26
    ...
    sets.precast.WS['Last Stand'] = {
		head={ name="Herculean Helm", augments={'Rng.Acc.+5 Rng.Atk.+5','Weapon skill damage +4%','Rng.Acc.+6',}},
		body={ name="Herculean Vest", augments={'Mag. Acc.+15 "Mag.Atk.Bns."+15','Attack+12','Weapon skill damage +5%','Accuracy+12 Attack+12',}},
		hands="Meg. Gloves +2",
		legs="Meg. Chausses +2",
		feet={ name="Herculean Boots", augments={'Rng.Acc.+17 Rng.Atk.+17','Weapon skill damage +4%','DEX+5','Rng.Atk.+6',}},
		neck="Fotia Gorget",
		waist="Fotia Belt",
		left_ear="Telos Earring",
		right_ear="Enervating Earring",
		...
		back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+5','Weapon skill damage +10%',}},
		}
    ...
    sets.engaged = {
		...
		body="Meg. Cuirie +2",
		hands={ name="Herculean Gloves", augments={'Attack+16','"Triple Atk."+3',}},
		legs="Meg. Chausses +2",
		feet={ name="Herculean Boots", augments={'Attack+30','"Triple Atk."+3','DEX+3',}},
...
function set_lockstyle()
    send_command('wait 2; input /lockstyleset 8' .. lockstyleset)
end