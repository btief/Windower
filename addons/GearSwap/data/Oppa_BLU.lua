...
function job_setup()
    ...
    blue_magic_maps.Magical = S{
		...
		'Tenebral Crush','Entomb','Anvil Lightning'
    }
...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc', 'Refresh', 'Learning', 'DT')
...
function init_gear_sets()
    ...
    sets.precast.WS = {
		...
		back={ name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+5','Crit.hit rate+10',}},
		}
