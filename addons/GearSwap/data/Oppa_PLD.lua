	...
	sets.precast.JA['Provoke'] =    --enmity +152
{
    ...
    body={ name="Souv. Cuirass +1", augments={'HP+90','Enmity+8','Potency of "Cure" effect received +12%',}},
    hands={ name="Yorium Gauntlets", augments={'Enmity+9',}},
    legs={ name="Odyssean Cuisses", augments={'Accuracy+24 Attack+24','Enmity+6','Accuracy+2',}},
...
{	
    ...
    --Stat Modifier: WS damage + 62   2273DMG maxaggro
    sets.precast.WS['Atonement'] = 
{
	ammo="Iron Gobbet",
    head={ name="Odyssean Helm", augments={'"Dbl.Atk."+3','STR+3','Weapon skill damage +8%','Mag. Acc.+14 "Mag.Atk.Bns."+14',}},				
