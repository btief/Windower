...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Myochin Kabuto +1",hands="Saotome Kote +1"}
    ...
    sets.precast.WS = {ammo="Black tathlum",
        head="Gnadbhod's helm",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Kirin's Osode",hands="Alkyoneus's bracelets",ring1="Rajas Ring",ring2="Flame ring",
	...
	sets.precast.WS['Tachi: Kaiten'] = set_combine(sets.precast.WS, {neck="Light Gorget"})
    sets.precast.WS['Tachi: Kaiten'].Acc = set_combine(sets.precast.WS.Acc, {neck="Light Gorget"})
    sets.precast.WS['Tachi: Kaiten'].Mod = set_combine(sets.precast.WS['Tachi: Kaiten'], {waist="Light Belt"})
    ...
    sets.engaged = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Acc = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.PDT = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Acc.PDT = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Reraise = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Acc.Reraise = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    ...
    sets.engaged.Adoulin = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Adoulin.Acc = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Adoulin.PDT = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Adoulin.Acc.PDT = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Adoulin.Reraise = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
    sets.engaged.Adoulin.Acc.Reraise = {ammo="Black tathlum",
        head="Walahra turban",neck="Justice torque",ear1="Brutal Earring",ear2="Bushinomimi",
        body="Usukane haramaki",hands="Dusk gloves +1",ring1="Rajas Ring",ring2="Mars's ring",
        back="Cerberus mantle +1",waist="Ninurta's sash",legs="Byakko's haidate",feet="Usukane sune-ate"}
