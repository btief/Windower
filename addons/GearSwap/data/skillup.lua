...
user_settings = {
    user_spells = {
        ...
        Enhancing = T{'Barfire', 'Barblizzard'},
        Ninjutsu = T{},
        Singing = T{"Mage's Ballad", "Mage's Ballad II"},
        Blue = T{},
        Summoning = T{}},
...
sets.brd = {
    ...
    string_inst = {
        range=""},}--put your string instrument here
sets.Idle = {
...
function get_sets()
    ...
    gs_skillup = {color={GEO=true,HEL=true,ENH=true,NIN=true,SIN=true,BLU=true,SMN=true,STOP=true,DOWN=true,LOG=true,TRUST=true,TEST=true,REF=true,ITEM=true},
                skill_ups={},total_skill_ups=0,skill={},use_trust=true,use_item=false,use_geo=false,test_mode=false,test_brd="Wind",skipped_spells=T{}}
